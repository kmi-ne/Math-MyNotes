...
\setlist[thmlist, 1]{label=\arabic{thmlisti}., ref=\arabic{thmlisti}, itemsep=1ex}
...
% \seq_new:N \g_my_assumplist_seq
% \NewDocumentCommand{ \Catch } { mm } {
%   \seq_gput_right:Nn \g_my_assumplist_seq { #1 }
% }
\ExplSyntaxOff
...
\NewDocumentCommand{\defitem}{mmmmO{}}{%
  \crefname{thmlist#1}{#3.}{#3s.}
  % 1: label. 2: nameref. 3: subtitle.
  \NewTColorBox[use counter from=none, crefname={#3.}{#3s.}]{#1}{O{}O{}O{}}{%
    enhanced, breakable,
    boxrule=0pt, frame hidden,
    sharp corners=west,
    top=1pt, middle=1pt, bottom=1pt,
    colback=#4!10!white, skin=bicolor, colbacklower=white,
    coltitle=#4, fonttitle=\bfseries,
    borderline west={2pt}{0pt}{#4},
    attach boxed title to top left={xshift=-12pt},
    boxed title style={tile, size=minimal, colback=white, bottom=2pt, borderline south={.5pt}{0pt}{#4}},
    ...
    before lower={\ifstrempty{#5}{}{\textbf{#5:}\hspace{1em}}},%
  }%
}
\defitem{dfn}{Definition}{Def}{myblue}[Example]
\defitem{lem}{Lemma}{Lem}{mygreen}[Proof]
\defitem{prp}{Proposition}{Prop}{mygreen}[Proof]
\defitem{thm}{Theorem}{Thm}{mygreen}[Proof]
\defitem{axm}{Axiom}{Axiom}{myred}
\defitem{cnv}{Convention}{Conv}{mygray}
