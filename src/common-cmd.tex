\makeatletter
% 環境
\newbool{MyBoolOutsideEq}\booltrue{MyBoolOutsideEq}
\newcommand{\?}{
  \ifbool{MyBoolOutsideEq}{
    \setbool{MyBoolOutsideEq}{false}
    \hfill$\begin{aligned}[t]
  }{
    \end{aligned}$\hfill\null
    \setbool{MyBoolOutsideEq}{true}
  }
}
...
% 非記号系コマンド
\newbool{MyBoolNotRed}\booltrue{MyBoolNotRed}
